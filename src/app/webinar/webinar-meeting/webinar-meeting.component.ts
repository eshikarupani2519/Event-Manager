...
// fetch("http://localhost:5001/engagement-score",{
// method:"POST",
// headers:{
...
// console.log("Engagement Score:",data)
// })
...
export class WebinarMeetingComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    document.addEventListener("visibilitychange", () => {
      this.tabFocus = document.hidden ? 20 : 100;
    });
  ...
  loadSummary() {
    ...
    this.eventService.getSummary(this.meetingId).subscribe({
      ...
      error: (err) => console.log("Summary error:", err)
    });
  }
}